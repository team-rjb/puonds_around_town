                ...
                <div className="car-details">
                    <div>
                        ...
                        <div className="p-grid">
                            <div className="p-col-12">Name: <b>{this.props.posts}</b></div>
                            <div className="p-col-12">Age: <b>{car.year}</b></div>
                            <div className="p-col-12">Breed: <b>{car.brand}</b></div>
                            {/* <div className="p-col-12">Organization: <b>{car.color}</b></div> */}
                        </div>
                    </div>
