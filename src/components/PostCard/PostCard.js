  ...
  render() {
    return (
      <div className="dog-container">
          {this.state.editPost ? (
  <div>
<EditPost post_id={this.props.post_id}
        handleEditClick ={this.handleEditClick}/>
          ...
          <section className="dog-info">
            ...
            <div className="icon-and-info">
              ...
              <h4 className="full-dog-rating">Rating: {this.props.rating}/10</h4>
            </div>
            <div className="icon-and-info">
              <img className="icons" src={locationicon} alt="dog house" />
              <h4 className="full-dog-org_name">
                Organization: {this.props.org_name}
              </h4>
            </div>
            <div className="icon-and-info">
              <img className="icons" src={bioicon} alt="open book" />
              <section className="bio-chunk">
                <h5 className="full-dog-bio">
                  {" "}
                  <span className="bio-header">Bio: </span> {this.props.bio}
                </h5>
              </section>
            </div>
            ...
            <div>
              {this.props.isAdmin ? (
                ...
                <img
                  onClick={() => this.props.addToFavorites(this.props.post_id)}
                  className="fav-icon-white"
